"""
============================================================
EduMindAI Enterprise v3.7 - Full Fixed & Vision Integrated
============================================================
"""
...
with col1:
    ...
    st.caption("AI Chat • Multilingual • Code • Reasoning • Database • PDF • Vision")
...
with st.sidebar:
    ...
    if st.session_state.pdf_context:
        st.info("✅ PDF xotirada saqlangan.")
...
for message in st.session_state.messages:
    ...
    with st.chat_message(role):
        ...
        if file_obj is not None:
            try:
                if hasattr(file_obj, "type") and file_obj.type in ["image/png", "image/jpeg", "image/jpg"]:
...
with col_input:
    prompt = st.chat_input("EduMindAI bilan suhbatni boshlang yoki rasm yuboring...")
...
if prompt or uploaded_chat_file:
    user_content = prompt if prompt else "Rasm yuborildi."
    ...
    with st.chat_message("assistant"):
        ...
        try:
            # Agar rasm yuklangan bo'lsa Vision orqali tahlil qilamiz
            if uploaded_chat_file is not None and uploaded_chat_file.type in ["image/png", "image/jpeg", "image/jpg"]:
                response = ai.vision_chat(image=uploaded_chat_file, user_prompt=prompt)
